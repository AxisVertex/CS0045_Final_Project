...
void Scene5::updateCutscene(sf::Time dt) {
    ...
    case CutscenePart::FadeIn: {
        if (elapsedTime < 2.0f) {
            ...
            if (m_voiceLine.getStatus() != sf::Sound::Playing) {
                m_voiceLine.setBuffer(m_soundBuffers[0]);
                m_voiceLine.play();
            }
        } else {
            m_voiceLine.stop(); 
            ...
            m_partClock.restart();
            m_voiceLine.setBuffer(m_soundBuffers[1]); 
            m_voiceLine.play();
        }
        break;
    }
    ...
    case CutscenePart::ClapClapClap: { 
        ...
        if (elapsedTime > 3.0f) { 
            ...
            m_partClock.restart();
            m_voiceLine.setBuffer(m_soundBuffers[2]); 
            m_voiceLine.play();
        }
        break;
    }
    ...
    case CutscenePart::ArjoWalksIn: { 
        ...
        if (elapsedTime > 9.0f) { 
            ...
            m_partClock.restart();
            m_voiceLine.setBuffer(m_soundBuffers[3]); 
            m_voiceLine.play();
        }
        break;
    }
    ...
    case CutscenePart::AldenStands: { 
        ...
        if (elapsedTime > 8.0f) {
            ...
            m_partClock.restart();
            m_voiceLine.setBuffer(m_soundBuffers[4]); 
            m_voiceLine.play();
        }
        break;
    }
    ...
    case CutscenePart::ArjoMoves: { 
        setSubtitle(L"");
        float t = std::min(1.0f, elapsedTime / 1.5f); 
        float moveX = w * 0.4f * t; 
        m_arjoMoveTransform = sf::Transform::Identity;
    ...
    case CutscenePart::RevealYaya: { 
        setSubtitle(L""); 
        m_arjoMoveTransform = sf::Transform::Identity; 
        m_arjoMoveTransform.translate(w * 0.4f, 0); 
        if (elapsedTime > 2.0f) {
            m_currentPart = CutscenePart::YayaZoomIn; 
            m_partClock.restart();
            m_voiceLine.setBuffer(m_soundBuffers[5]);
            m_voiceLine.play();
        }
        break;
    }
    ...
    case CutscenePart::YayaZoomIn: { 
        ...
        if (elapsedTime > 4.0f) { 
            ...
            m_partClock.restart();
            m_voiceLine.setBuffer(m_soundBuffers[6]); 
            m_voiceLine.play();
        }
        break;
    }
    ...
    case CutscenePart::AldenDetermined: { 
        ...
        if (elapsedTime > 6.0f) { 
            ...
            m_partClock.restart();
            m_voiceLine.setBuffer(m_soundBuffers[7]); 
            m_voiceLine.play();
        }
        break;
    }
    ...
    case CutscenePart::AldenLooksAtSipa: {
        ...
        if (elapsedTime > 2.5f) { 
            ...
            m_partClock.restart();
            m_voiceLine.setBuffer(m_soundBuffers[8]); 
            m_voiceLine.play();
        }
        break;
    }
    ...
    case CutscenePart::ArjoFinalChallenge: { 
        ...
        if (elapsedTime > 6.0f) { 
            ...
            m_partClock.restart();
            m_voiceLine.setBuffer(m_soundBuffers[9]); 
            m_voiceLine.play();
        }
        break;
    }
    ...
    case CutscenePart::AldenAccepts: { 
        ...
        if (elapsedTime > 8.0f) { 
            ...
            m_partClock.restart();
            m_voiceLine.setBuffer(m_soundBuffers[10]);
            m_voiceLine.play();
        }
        break;
    }
